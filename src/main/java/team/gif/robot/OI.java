...
//    public final XboxController driver = new XboxController(RobotMap.DRIVER_CONTROLLER_ID);
    public final Joystick leftStick = new Joystick(RobotMap.LEFT_STICK_PORT);
    public final Joystick rightStick = new Joystick(RobotMap.RIGHT_STICK_PORT);
...
//    public final POVButton dDPadLeft = new POVButton(driver, 270);
    ...
    private final Button rightTrigger = new JoystickButton(rightStick, 1);
